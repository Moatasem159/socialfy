...
class SmallMessageWidget extends StatelessWidget {
  final bool isSender;
  final String message;
  final String time;
  const SmallMessageWidget({super.key, required this.isSender,required this.message,required this.time});
  @override
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Flexible(
              child: Padding(
                  padding: const EdgeInsets.only(bottom: 9,left: 5,right: 5),
